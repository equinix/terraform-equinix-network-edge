...
| <a name="input_additional_bandwidth"></a> [additional\_bandwidth](#input\_additional\_bandwidth) | Additional internet bandwidth for a device | `number` | n/a | yes |
| <a name="input_hostname"></a> [hostname](#input\_hostname) | Device hostname | `string` | n/a | yes |
