output "id" {
  ...
  value       = equinix_network_device.ha.uuid
}

output "status" {
  description = "Device provisioning status"
  value       = equinix_network_device.ha.status
}

output "license_status" {
  description = "Device license status"
  value       = equinix_network_device.ha.license_status
}

output "account_number" {
  description = "Device billing account number"
  value       = equinix_network_device.ha.account_number
}
...
output "region" {
  ...
  value       = equinix_network_device.ha.region
}

output "ibx" {
  description = "Device IBX center"
  value       = equinix_network_device.ha.ibx
}

output "ssh_ip_address" {
  description = "Device SSH interface IP address"
  value       = equinix_network_device.ha.ssh_ip_address
}

output "ssh_ip_fqdn" {
  description = "Device SSH interface FQDN"
  value       = equinix_network_device.ha.ssh_ip_fqdn
}

output "interfaces" {
  description = "Device interfaces"
  value       = equinix_network_device.ha.interface
}
