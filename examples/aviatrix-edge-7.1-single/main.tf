...
module "aviatrix_edge_7_1" {
  ...
  acl_template_id      = equinix_network_acl_template.aviatrix_edge_7_1_single_wan_acl_template.id

}


resource "equinix_network_acl_template" "aviatrix_edge_7_1_single_wan_acl_template" {
  name        = "tf-aviatrix-edge-7.1-pri-wan-acl"
